#!/usr/bin/env python3
"""Re-download a previously-triggered LinkedIn snapshot.
...
Works for all four LinkedIn datasets (people, company, jobs, posts) —
the snapshot_id already encodes which dataset it came from.
"""
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Download an existing Bright Data LinkedIn snapshot by id.",
    )
    ap.add_argument(
        "--snapshot-id",
        required=True,
