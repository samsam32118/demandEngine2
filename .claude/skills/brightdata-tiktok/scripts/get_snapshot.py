#!/usr/bin/env python3
"""Re-download a previously-triggered TikTok snapshot.
...
Works for all four TikTok datasets (profiles, posts, comments, shop) —
...
def main() -> None:
    ap = argparse.ArgumentParser(
        description="Download an existing Bright Data TikTok snapshot by id.",
    )
    ap.add_argument(
        "--snapshot-id",
        required=True,
